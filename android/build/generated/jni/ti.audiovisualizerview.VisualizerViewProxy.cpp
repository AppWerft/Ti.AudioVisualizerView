...
, javaClass, nameSymbol);
	...
	// Method bindings --------------------------------------------------------
	DEFINE_PROTOTYPE_METHOD(proxyTemplate, "printMessage", VisualizerViewProxy::printMessage);
	DEFINE_PROTOTYPE_METHOD(proxyTemplate, "getMessage", VisualizerViewProxy::getMessage);
	DEFINE_PROTOTYPE_METHOD(proxyTemplate, "setMessage", VisualizerViewProxy::setMessage);
	...
	instanceTemplate->SetAccessor(String::NewSymbol("message"),
			VisualizerViewProxy::getter_message
			, VisualizerViewProxy::setter_message
...
// Methods --------------------------------------------------------------------
Handle<Value> VisualizerViewProxy::printMessage(const Arguments& args)
{
	...
	if (!methodID) {
		methodID = env->GetMethodID(VisualizerViewProxy::javaClass, "printMessage", "(Ljava/lang/String;)V");
		if (!methodID) {
...
Handle<Value> VisualizerViewProxy::getMessage(const Arguments& args)
{
	LOGD(TAG, "getMessage()");
	HandleScope scope;
	...
	static jmethodID methodID = NULL;
	if (!methodID) {
		methodID = env->GetMethodID(VisualizerViewProxy::javaClass, "getMessage", "()Ljava/lang/String;");
		if (!methodID) {
...
Handle<Value> VisualizerViewProxy::setMessage(const Arguments& args)
{
	LOGD(TAG, "setMessage()");
	HandleScope scope;
	...
	static jmethodID methodID = NULL;
	if (!methodID) {
		methodID = env->GetMethodID(VisualizerViewProxy::javaClass, "setMessage", "(Ljava/lang/String;)V");
		if (!methodID) {
...
Handle<Value> VisualizerViewProxy::getter_message(Local<String> property, const AccessorInfo& info)
{
...
void VisualizerViewProxy::setter_message(Local<String> property, Local<Value> value, const AccessorInfo& info)
{
